...
export async function POST(req: NextRequest): Promise<NextResponse> {
  try {
    ...
    await writeAuditLog({ action: 'student.create', actorId: user.id, actorUsername: user.username, actorRole: user.role, targetType: 'student', targetId: student._id.toString(), targetName: fullName, batchIds: [batchId] });
