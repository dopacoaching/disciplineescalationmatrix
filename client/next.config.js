    ...
    return [
      {
        ...
        headers: [
          ...
          // 'unsafe-eval' is added in development only: Next.js hot-reload
          // (react-refresh) evaluates code via eval(), which a strict policy blocks.
          // Production keeps the stricter policy without 'unsafe-eval'.
          {
